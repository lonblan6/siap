...
$sql = "SELECT id, Usuario, Clave, Nombre_Completo FROM usuarios";
...
<H1 style align="center">Usuarios SIAP 16 de Enero</H1>

<table width="870" border="1" align="center">
  <tbody>
    <tr>
      <th width="66" align="center">Id</th>
      <th width="168" align="center">Usuario</th>
      <th width="391" align="center">Clave</th>
      <th width="111" align="center">Nombre_Completo</th>
...
<table style="border: 0.5px solid #14C5E6" width="870" height="52" border="1" align="center">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="171"><?php echo $row['Usuario'] ?></td>
      <td width="390"><?php echo $row['Clave'] ?></td>
      <td width="110"><?php echo $row['Nombtre_Completo'] ?></td>
